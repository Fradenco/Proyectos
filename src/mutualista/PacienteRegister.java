...
public class PacienteRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelBase.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 130, 30));

        txt_telefono.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        PanelBase.add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 240, 30));

        jLabel7.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel7.setText("Cédula");
        PanelBase.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 130, 30));

        txt_cedula.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        PanelBase.add(txt_cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 240, 30));

        jLabel8.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel8.setText("Contraseña");
        PanelBase.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 130, 30));
        ...
        PanelBase.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 130, 30));

        x_contrasena.setText("Las contraseñas no coinciden");
        PanelBase.add(x_contrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 420, 240, -1));
        ...
        PanelBase.add(txt_contrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 240, 30));
        ...
        PanelBase.add(txt_concontrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 240, 30));
